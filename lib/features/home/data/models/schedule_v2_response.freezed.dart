...
as List<AttachmentV2>,scopeImages: null == scopeImages ? _self.scopeImages : scopeImages // ignore: cast_nullable_to_non_nullable
...
class _ScheduleV2Response implements ScheduleV2Response {
  const _ScheduleV2Response({required this.id, required this.scheduleName, required this.status, required this.description, required this.createdAt, required this.updatedAt, required this.dueDate, this.inspectionDate, required this.isRBISchedule, required this.isRecurring, this.inspectionInterval, this.damageMechanism, this.inspectionEffectiveness, this.aiSummary, this.comments, required this.isDeleted, required this.scheduleTypeId, required this.operationId, required this.equipmentId, required this.createdById, this.approvedById, this.reviewedById, required final  List<AttachmentV2> attachments, required final  List<AttachmentV2> scopeImages, required final  List<ChecklistQuestionTemplate> checklistQuestionTemplates, required final  List<InspectionMethodV2> inspectionMethods, required final  List<PotentialEmergentWorkV2> potentialEmergentWorks, required final  List<ScheduleComponent> components, this.approvedBy, this.createdBy, this.reviewedBy, this.equipment, this.operation, this.scheduleType, this.record}): _attachments = attachments,_scopeImages = scopeImages,_checklistQuestionTemplates = checklistQuestionTemplates,_inspectionMethods = inspectionMethods,_potentialEmergentWorks = potentialEmergentWorks,_components = components;
...
@override List<AttachmentV2> get scopeImages {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ScheduleV2Response&&(identical(other.id, id) || other.id == id)&&(identical(other.scheduleName, scheduleName) || other.scheduleName == scheduleName)&&(identical(other.status, status) || other.status == status)&&(identical(other.description, description) || other.description == description)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.dueDate, dueDate) || other.dueDate == dueDate)&&(identical(other.inspectionDate, inspectionDate) || other.inspectionDate == inspectionDate)&&(identical(other.isRBISchedule, isRBISchedule) || other.isRBISchedule == isRBISchedule)&&(identical(other.isRecurring, isRecurring) || other.isRecurring == isRecurring)&&(identical(other.inspectionInterval, inspectionInterval) || other.inspectionInterval == inspectionInterval)&&(identical(other.damageMechanism, damageMechanism) || other.damageMechanism == damageMechanism)&&(identical(other.inspectionEffectiveness, inspectionEffectiveness) || other.inspectionEffectiveness == inspectionEffectiveness)&&(identical(other.aiSummary, aiSummary) || other.aiSummary == aiSummary)&&(identical(other.comments, comments) || other.comments == comments)&&(identical(other.isDeleted, isDeleted) || other.isDeleted == isDeleted)&&(identical(other.scheduleTypeId, scheduleTypeId) || other.scheduleTypeId == scheduleTypeId)&&(identical(other.operationId, operationId) || other.operationId == operationId)&&(identical(other.equipmentId, equipmentId) || other.equipmentId == equipmentId)&&(identical(other.createdById, createdById) || other.createdById == createdById)&&(identical(other.approvedById, approvedById) || other.approvedById == approvedById)&&(identical(other.reviewedById, reviewedById) || other.reviewedById == reviewedById)&&const DeepCollectionEquality().equals(other._attachments, _attachments)&&const DeepCollectionEquality().equals(other._scopeImages, _scopeImages)&&const DeepCollectionEquality().equals(other._checklistQuestionTemplates, _checklistQuestionTemplates)&&const DeepCollectionEquality().equals(other._inspectionMethods, _inspectionMethods)&&const DeepCollectionEquality().equals(other._potentialEmergentWorks, _potentialEmergentWorks)&&const DeepCollectionEquality().equals(other._components, _components)&&(identical(other.approvedBy, approvedBy) || other.approvedBy == approvedBy)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&(identical(other.reviewedBy, reviewedBy) || other.reviewedBy == reviewedBy)&&(identical(other.equipment, equipment) || other.equipment == equipment)&&(identical(other.operation, operation) || other.operation == operation)&&(identical(other.scheduleType, scheduleType) || other.scheduleType == scheduleType)&&(identical(other.record, record) || other.record == record));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,scheduleName,status,description,createdAt,updatedAt,dueDate,inspectionDate,isRBISchedule,isRecurring,inspectionInterval,damageMechanism,inspectionEffectiveness,aiSummary,comments,isDeleted,scheduleTypeId,operationId,equipmentId,createdById,approvedById,reviewedById,const DeepCollectionEquality().hash(_attachments),const DeepCollectionEquality().hash(_scopeImages),const DeepCollectionEquality().hash(_checklistQuestionTemplates),const DeepCollectionEquality().hash(_inspectionMethods),const DeepCollectionEquality().hash(_potentialEmergentWorks),const DeepCollectionEquality().hash(_components),approvedBy,createdBy,reviewedBy,equipment,operation,scheduleType,record]);
...
as List<AttachmentV2>,scopeImages: null == scopeImages ? _self._scopeImages : scopeImages // ignore: cast_nullable_to_non_nullable
