...
mixin _$RecordResponse {
 ...
 String get id; String get recordID; String get equipmentId; String get description;@JsonKey(name: 'creditedItems') List<Map<String, dynamic>>? get creditedItems;@JsonKey(name: 'recordCreatedDate') DateTime? get recordCreatedDate;@JsonKey(name: 'inspectedComponents') List<Map<String, dynamic>>? get inspectedComponents;@JsonKey(name: 'scheduleType') Map<String, dynamic>? get scheduleType; String? get status;@JsonKey(name: 'inspectionDate') DateTime? get inspectionDate; String? get actionCreated;@JsonKey(name: 'attachments') List<Map<String, dynamic>>? get attachments; String? get comments;
...
@useResult
$Res call({
 String id, String recordID, String equipmentId, String description,@JsonKey(name: 'creditedItems') List<Map<String, dynamic>>? creditedItems,@JsonKey(name: 'recordCreatedDate') DateTime? recordCreatedDate,@JsonKey(name: 'inspectedComponents') List<Map<String, dynamic>>? inspectedComponents,@JsonKey(name: 'scheduleType') Map<String, dynamic>? scheduleType, String? status,@JsonKey(name: 'inspectionDate') DateTime? inspectionDate, String? actionCreated,@JsonKey(name: 'attachments') List<Map<String, dynamic>>? attachments, String? comments
});
...
/// Create a copy of RecordResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? recordID = null,Object? equipmentId = null,Object? description = null,Object? creditedItems = freezed,Object? recordCreatedDate = freezed,Object? inspectedComponents = freezed,Object? scheduleType = freezed,Object? status = freezed,Object? inspectionDate = freezed,Object? actionCreated = freezed,Object? attachments = freezed,Object? comments = freezed,}) {
...
as List<Map<String, dynamic>>?,recordCreatedDate: freezed == recordCreatedDate ? _self.recordCreatedDate : recordCreatedDate // ignore: cast_nullable_to_non_nullable
...
as List<Map<String, dynamic>>?,scheduleType: freezed == scheduleType ? _self.scheduleType : scheduleType // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String recordID,  String equipmentId,  String description, @JsonKey(name: 'creditedItems')  List<Map<String, dynamic>>? creditedItems, @JsonKey(name: 'recordCreatedDate')  DateTime? recordCreatedDate, @JsonKey(name: 'inspectedComponents')  List<Map<String, dynamic>>? inspectedComponents, @JsonKey(name: 'scheduleType')  Map<String, dynamic>? scheduleType,  String? status, @JsonKey(name: 'inspectionDate')  DateTime? inspectionDate,  String? actionCreated, @JsonKey(name: 'attachments')  List<Map<String, dynamic>>? attachments,  String? comments)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RecordResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String recordID,  String equipmentId,  String description, @JsonKey(name: 'creditedItems')  List<Map<String, dynamic>>? creditedItems, @JsonKey(name: 'recordCreatedDate')  DateTime? recordCreatedDate, @JsonKey(name: 'inspectedComponents')  List<Map<String, dynamic>>? inspectedComponents, @JsonKey(name: 'scheduleType')  Map<String, dynamic>? scheduleType,  String? status, @JsonKey(name: 'inspectionDate')  DateTime? inspectionDate,  String? actionCreated, @JsonKey(name: 'attachments')  List<Map<String, dynamic>>? attachments,  String? comments)  $default,) {final _that = this;
switch (_that) {
case _RecordResponse():
return $default(_that.id,_that.recordID,_that.equipmentId,_that.description,_that.creditedItems,_that.recordCreatedDate,_that.inspectedComponents,_that.scheduleType,_that.status,_that.inspectionDate,_that.actionCreated,_that.attachments,_that.comments);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String recordID,  String equipmentId,  String description, @JsonKey(name: 'creditedItems')  List<Map<String, dynamic>>? creditedItems, @JsonKey(name: 'recordCreatedDate')  DateTime? recordCreatedDate, @JsonKey(name: 'inspectedComponents')  List<Map<String, dynamic>>? inspectedComponents, @JsonKey(name: 'scheduleType')  Map<String, dynamic>? scheduleType,  String? status, @JsonKey(name: 'inspectionDate')  DateTime? inspectionDate,  String? actionCreated, @JsonKey(name: 'attachments')  List<Map<String, dynamic>>? attachments,  String? comments)?  $default,) {final _that = this;
switch (_that) {
case _RecordResponse() when $default != null:
return $default(_that.id,_that.recordID,_that.equipmentId,_that.description,_that.creditedItems,_that.recordCreatedDate,_that.inspectedComponents,_that.scheduleType,_that.status,_that.inspectionDate,_that.actionCreated,_that.attachments,_that.comments);case _:
  return null;
...
class _RecordResponse implements RecordResponse {
  const _RecordResponse({required this.id, required this.recordID, required this.equipmentId, required this.description, @JsonKey(name: 'creditedItems') final  List<Map<String, dynamic>>? creditedItems, @JsonKey(name: 'recordCreatedDate') this.recordCreatedDate, @JsonKey(name: 'inspectedComponents') final  List<Map<String, dynamic>>? inspectedComponents, @JsonKey(name: 'scheduleType') final  Map<String, dynamic>? scheduleType, this.status, @JsonKey(name: 'inspectionDate') this.inspectionDate, this.actionCreated, @JsonKey(name: 'attachments') final  List<Map<String, dynamic>>? attachments, this.comments}): _creditedItems = creditedItems,_inspectedComponents = inspectedComponents,_scheduleType = scheduleType,_attachments = attachments;
...
@override final  String description;
 final  List<Map<String, dynamic>>? _creditedItems;
@override@JsonKey(name: 'creditedItems') List<Map<String, dynamic>>? get creditedItems {
...
@override@JsonKey(name: 'recordCreatedDate') final  DateTime? recordCreatedDate;
 final  List<Map<String, dynamic>>? _inspectedComponents;
@override@JsonKey(name: 'inspectedComponents') List<Map<String, dynamic>>? get inspectedComponents {
...
/// Create a copy of RecordResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? recordID = null,Object? equipmentId = null,Object? description = null,Object? creditedItems = freezed,Object? recordCreatedDate = freezed,Object? inspectedComponents = freezed,Object? scheduleType = freezed,Object? status = freezed,Object? inspectionDate = freezed,Object? actionCreated = freezed,Object? attachments = freezed,Object? comments = freezed,}) {
...
as List<Map<String, dynamic>>?,scheduleType: freezed == scheduleType ? _self._scheduleType : scheduleType // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,status: freezed == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as String?,inspectionDate: freezed == inspectionDate ? _self.inspectionDate : inspectionDate // ignore: cast_nullable_to_non_nullable
as DateTime?,actionCreated: freezed == actionCreated ? _self.actionCreated : actionCreated // ignore: cast_nullable_to_non_nullable
